package com.ohgiraffers.section04.enumfile;
 ...
 */
@Entity(name = "menber_section04")
@Table(name = "tbl_menber_section04")
public class Member {
...
//    @Enumerated(EnumType.STRING) // Enum파일 이름으로 설정됨 (String일 경우 admin이면 admin....그렇게 됨)
    ...
    public Member(int memberNo, String memberId, String memberPwd, String nickName, String phone, String email, String address, String enrollDate, RoleType memberRole, String status) {
